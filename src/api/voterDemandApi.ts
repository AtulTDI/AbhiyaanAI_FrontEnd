...
export const getDemandsByCategory = (categoryId: string) => {
  return axios.get<Demand[]>(`/VotersDemand/get-demands-by-category/${categoryId}`, {
    useApiPrefix: true,
    useVoterBase: true
  });
};
 ...
 * Add voter demands
 */
export const addVoterDemands = (voterId: string, payload: VoterDemandItem[]) => {
  return axios.post<string>(`/VotersDemand/add-voter-demands/${voterId}`, payload, {
    useApiPrefix: true,
    useVoterBase: true
  });
};
 ...
 */
export const updateVoterDemands = (payload: VoterDemandUpdatePayload[]) => {
  return axios.put<string>(`/VotersDemand/update-demands`, payload, {
    useApiPrefix: true,
    useVoterBase: true
  });
};
...
export const getVoterDemands = (voterId: string, isResolved?: boolean) => {
  return axios.get<VoterDemandItem[]>(`/VotersDemand/get-voter-demands/${voterId}`, {
    params: { isResolved },
    useApiPrefix: true,
    useVoterBase: true
  });
